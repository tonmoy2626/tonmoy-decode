...
\033[0;94m   _____ ___  _   _ __  __  _____   __
...
\033[0;96m    |_| \___/|_| \_|_|  |_|\___/ |_|  

""")

print("\033[0;91mThis Tool's Free By Tonmoy mahato")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : sorry

    print '\033[0;94mFACEBOOK : TONMOY'

    print '\033[0;96mGITHUB   : tonmoy2626'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[TONMOY-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[TONMOY-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
